...
public class S1402 extends AbstractSkillStrategy {
    ...
    protected void applySkill(PlayerData playerData, MonsterData monsterData, List<Pair<String, SkillType>> resultList) {
        ...
        int damage = critical((int) (playerStatus.getDamage() * 3.5), playerStatus.getCriticalDamage(), playerStatus.getCriticalChance() + 30);
