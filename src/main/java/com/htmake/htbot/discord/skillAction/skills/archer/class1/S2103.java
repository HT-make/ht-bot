...
public class S2103 extends AbstractSkillStrategy {
    ...
    protected void applySkill(PlayerData playerData, MonsterData monsterData, List<Pair<String, SkillType>> resultList) {
        ...
        int damage = critical((int) (playerStatus.getDamage() * 1.7), playerStatus.getCriticalDamage(), playerStatus.getCriticalChance() + 15, playerStatus.getJob());
