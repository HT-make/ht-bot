...
public class S1302 extends AbstractSkillStrategy {
    ...
    protected void applySkill(PlayerData playerData, MonsterData monsterData, List<Pair<String, SkillType>> resultList) {
        ...
        int damage = critical((int) (playerStatus.getDamage() * 3.5), playerStatus.getCriticalDamage() + 100, playerStatus.getCriticalChance());
