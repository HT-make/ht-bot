...
public class S2301 implements SkillStrategy {
    ...
    public List<Pair<String, SkillType>> execute(PlayerData playerData, MonsterData monsterData) {
        ...
        int damage = critical((int) (playerStatus.getDamage() * 4.0), playerStatus.getCriticalDamage(), playerStatus.getCriticalChance() + 50);
