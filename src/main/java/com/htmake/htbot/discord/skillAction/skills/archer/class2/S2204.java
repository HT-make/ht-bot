...
public class S2204 extends AbstractSkillStrategy {
    ...
    protected void applySkill(PlayerData playerData, MonsterData monsterData, List<Pair<String, SkillType>> resultList) {
        ...
        int damage = critical((int) (playerStatus.getDamage() * 3.0), playerStatus.getCriticalDamage(), playerStatus.getCriticalChance() + 20, playerStatus.getJob());
