...
public class S1101 extends AbstractSkillStrategy {
    ...
    protected void applySkill(PlayerData playerData, MonsterData monsterData, List<Pair<String, SkillType>> resultList) {
        ...
        int damage = critical((int) (playerStatus.getDamage() * 1.3), playerStatus.getCriticalDamage(), playerStatus.getCriticalChance());
